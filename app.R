...
source("~/Documents/dashboard_alpha/sep.R")
source("~/Documents/dashbord_alpha/incidents.R")
source("~/Documents/dashbord_alpha/tasks.R")
source("~/Documents/dashbord_alpha/projects.R")
source("~/Documents/dashbord_alpha/siem_logsources.R")
source("~/Documents/dashbord_alpha/siem_offenses.R")
source("~/Documents/dashbord_alpha/certfeed.R")
source("~/Documents/dashbord_alpha/phishingsim.R")
source("~/Documents/dashbord_alpha/perimeter_IDSIPS.R")
source("~/Documents/dashbord_alpha/timeline.R")
